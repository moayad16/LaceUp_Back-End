...
public class addressesEndpoints {
    ...
    @DeleteMapping(path="/deleteAddress", produces = "application/json")
    public ResponseEntity<String> deleteAddress(@RequestHeader("Authorization") String token, @RequestParam String addressId) {
